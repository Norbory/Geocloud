  ...
  return (
    ...
    <>
        <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
         ...
         <aside id="sidebar-multi-level-sidebar" className="top-0 left-0 z-40 w-56 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
               ...
               <ul className="space-y-2 font-medium mt-12">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-amber-50">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                        ...
                        <span className="ml-3 text-amber-50">Inicio</span>
                  </NavLink>
                  </li>
                  <li>
                     <button
                     ...
                     <ul id="dropdown-example" className={`${isDropdownOpen ? "" : "hidden"}  py-2 space-y-2`}>
                           <li>
                              <NavLink to="/device" className="text-amber-50 flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-slate-400  dark:text-white dark:hover:bg-gray-700"><span className="text-amber-50">Piezometro 101</span></NavLink>
                           </li>
                           <li>
                              <a href="#" className="text-amber-50 flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-slate-400  dark:text-white dark:hover:bg-gray-700"><span className="text-amber-50">Piezometro 102</span></a>
                           </li>
                           <li>
                              <a href="#" className="text-amber-50 flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-slate-400  dark:text-white dark:hover:bg-gray-700"><span className="text-amber-50">Piezometro 103</span></a>
                           </li>
                     </ul>
                  </li>
                  <li>
